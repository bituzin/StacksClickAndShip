          ...
          <div className="max-w-7xl mx-auto">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-orange-500/30 shadow-2xl">
              ...
              {showVoteModal && selectedPoll && (
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
                  <div className="bg-gradient-to-br from-orange-900/95 to-purple-900/95 backdrop-blur-xl rounded-2xl p-6 max-w-xl w-full max-h-[90vh] overflow-y-auto border border-orange-500/30 shadow-2xl ml-60" style={{marginLeft: '15rem', width: '28rem'}}>
                    <div className="flex justify-between items-center mb-6">
